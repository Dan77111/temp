  ...
  macchine.each do |marca,tipiCarburante|
    tipiCarburante.each do |tipoCarburante, modelli|
      ...
      loop do
        ...
        consumo = source[0..source.index("<")-1].strip.to_f.round(1)
...
macchine = getModelli(macchine)
p macchine["alfa_romeo"]["benzina"]["alfa romeo 159"]
